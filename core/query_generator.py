    ...
    def generate_catalog_sql(platform: str) -> str:
        ...
        if platform == "snowflake":
            ...
            WHERE t.DELETED IS NULL
              ...
              AND UPPER(t.TABLE_SCHEMA) NOT IN ('INFORMATION_SCHEMA', 'ACCOUNT_USAGE', 'CORE', 'INTERNAL_STAGES')
              AND UPPER(t.TABLE_NAME) NOT LIKE 'BIN$%'
              AND UPPER(t.TABLE_NAME) NOT IN ('ALERT_HISTORY', 'CORTEX_ANALYST_REQUEST_RAW', 'QUERY_HISTORY', 'LOGIN_HISTORY')
